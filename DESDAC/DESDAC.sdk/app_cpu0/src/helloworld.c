...
int main()
{	unsigned int *data;
	data = (unsigned int *) malloc(10000 * sizeof(unsigned int));
    init_platform();
    for(int i=0; i<10000; i++){
    	data[i]=(1000/2*(sin(2*3.14/10000*i)+1)+1000/2/1.5*(sin(3*2*3.14/10000*i)+1)+1000/2/2*(sin(5*2*3.14/10000*i)+1))*SCALE;
    ...
    dac_array(10000,data);
    //dac_disable();
    //dac_sin(65535,0,1000);
    //dac_dc(3300);
    cleanup_platform();
    free(data);
    return 0;
